    ...
    if not is_vertical:
        ...
        st.markdown(
            ...
            .stButton > button {
                ...
                font-size: 3px;      /* Ajusta el tamaño del texto en los botones */
            ...
            .stTextInput input {
                width: 10%;           /* Reduce el tamaño del cuadro de expresión */
                font-size: 5px;      /* Ajusta el tamaño del texto en el cuadro de expresión */
            }
            </style>
            """,
            unsafe_allow_html=True
